...
sha256sums=('fce6efcaf265492eb9bf479795e49b2868114c157709acc849302a9520919ab2'
            '6e761371afadf155b8bc25e94fd7de371c16130a87338300e5800924916a7a28' '8dcba5943623add45ae3fa048b8d3cf5743c5f7c45c432be05818433de328987')

package() {
	cd "$srcdir/"
	install -dm755 "$pkgdir/usr/bin"
	install -dm755 "$pkgdir/usr/share/$pkgname"
	cp -r $srcdir/Franz-linux-x64-${pkgver//./-}/* $pkgdir/usr/share/$pkgname/
	install -dm755 "$pkgdir/usr/bin"
